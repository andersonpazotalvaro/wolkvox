package co.smart.procesador.diagram.encuestainteligenteporskill.consumir;
...
@Component
public class ConsumirDiarioEncuestaInteligenteSkill {
    ...
    public ConsumirDiarioEncuestaInteligenteSkill(ServicioConsultarDatos servicioConsultarDatos, ServicioGenerarFechasDiarias servicioGenerarFechasDiarias) {
    ...
    public Response consumir() throws IOException {
        ...
        Request request = new Request.Builder()
                .url("https://wv"+ip+".wolkvox.com/api/v2/reports_manager.php?api=diagram_6&date_ini="+ini+"&date_end="+fin)
                .method("GET", null)
