package co.smart.procesador.agentes.tiempoporestado.consumir;
...
@Component
public class ConsumirDiarioTiempoPorEstado {
    ...
    public ConsumirDiarioTiempoPorEstado(ServicioConsultarDatos servicioConsultarDatos, ServicioGenerarFechasDiarias servicioGenerarFechasDiarias) {
    ...
    public Response consumir() throws IOException {
        ...
        Request request = new Request.Builder()
                .url("https://wv"+ip+".wolkvox.com/api/v2/reports_manager.php?api=agent_1&date_ini="+ini+"&date_end="+fin)
                .method("GET", null)
