package co.smart.procesador.skillsyservicios.workforceporhora.consumir;
...
@Component
public class ConsumirDiarioSkillsWorkforceHora {
    ...
    public ConsumirDiarioSkillsWorkforceHora(ServicioConsultarDatos servicioConsultarDatos, ServicioGenerarFechasDiarias servicioGenerarFechasDiarias) {
    ...
    public Response consumir() throws IOException {
        ...
        Request request = new Request.Builder()
                .url("https://wv"+ip+".wolkvox.com/api/v2/reports_manager.php?api=skill_5&skill_id=all&date_ini="+ini+"&date_end="+fin)
                .method("GET", null)
