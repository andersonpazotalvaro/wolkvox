package co.smart.procesador.campañas.resultadomaquinafinal.consumir;
...
@Component
public class ConsumirDiarioResultadoMaquinaFinal {
    ...
    public ConsumirDiarioResultadoMaquinaFinal(ServicioConsultarDatos servicioConsultarDatos, ServicioGenerarFechasDiarias servicioGenerarFechasDiarias) {
    ...
    public Response consumir() throws IOException {
        ...
        Request request = new Request.Builder()
                .url("https://wv"+ip+".wolkvox.com/api/v2/reports_manager.php?api=campaign_1&campaign_id=22109&date_ini="+ini+"&date_end="+fin)
                .method("GET", null)
