...
@Component
public class ConsumirDiarioSkillsDetalleLlamadasAbandonadas {
    ...
    public ConsumirDiarioSkillsDetalleLlamadasAbandonadas(ServicioConsultarDatos servicioConsultarDatos, ServicioGenerarFechasDiarias servicioGenerarFechasDiarias) {
