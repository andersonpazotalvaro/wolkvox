...
@Component
public class ConsumirDiarioInteraccionesConversaciones {
    ...
    public ConsumirDiarioInteraccionesConversaciones(ServicioConsultarDatos servicioConsultarDatos, ServicioGenerarFechasDiarias servicioGenerarFechasDiarias) {
