...
@Component
public class ConsumirResultadoMaquinaFinal {

private final ServicioConsultarDatos servicioConsultarDatos;

    public ConsumirResultadoMaquinaFinal(ServicioConsultarDatos servicioConsultarDatos) {
    ...
    public Response consumirr(String ini, String fin, String campaña) throws IOException {
            ...
            Request request = new Request.Builder()
                    .url("https://wv"+ip+".wolkvox.com/api/v2/reports_manager.php?api=campaign_1&campaign_id="+campaña+"&date_ini="+ini+"&date_end="+fin)
                    .method("GET", null)
