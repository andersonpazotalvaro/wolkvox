package co.smart.procesador.diagram.detalleesperainteligente.consumir;
...
@Component
public class ConsumirDiarioDetalleEsperaInteligente {
    ...
    public ConsumirDiarioDetalleEsperaInteligente(ServicioConsultarDatos servicioConsultarDatos, ServicioGenerarFechasDiarias servicioGenerarFechasDiarias) {
    ...
    public Response consumir() throws IOException {
        ...
        Request request = new Request.Builder()
                .url("https://wv"+ip+".wolkvox.com/api/v2/reports_manager.php?api=diagram_3&date_ini="+ini+"&date_end="+fin)
                .method("GET", null)
