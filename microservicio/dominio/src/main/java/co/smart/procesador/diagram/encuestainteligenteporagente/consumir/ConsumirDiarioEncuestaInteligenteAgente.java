package co.smart.procesador.diagram.encuestainteligenteporagente.consumir;
...
@Component
public class ConsumirDiarioEncuestaInteligenteAgente {
    ...
    public ConsumirDiarioEncuestaInteligenteAgente(ServicioConsultarDatos servicioConsultarDatos, ServicioGenerarFechasDiarias servicioGenerarFechasDiarias) {
    ...
    public Response consumir() throws IOException {
        ...
        Request request = new Request.Builder()
                .url("https://wv"+ip+".wolkvox.com/api/v2/reports_manager.php?api=diagram_5&date_ini="+ini+"&date_end="+fin)
                .method("GET", null)
