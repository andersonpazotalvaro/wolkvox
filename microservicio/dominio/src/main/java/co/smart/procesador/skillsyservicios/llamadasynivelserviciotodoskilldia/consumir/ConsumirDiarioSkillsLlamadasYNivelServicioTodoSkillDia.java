...
@Component
public class ConsumirDiarioSkillsLlamadasYNivelServicioTodoSkillDia {
    ...
    public ConsumirDiarioSkillsLlamadasYNivelServicioTodoSkillDia(ServicioConsultarDatos servicioConsultarDatos, ServicioGenerarFechasDiarias servicioGenerarFechasDiarias) {
