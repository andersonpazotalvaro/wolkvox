...
@Component
public class ConsumirDiarioEstadoPorHora {
    ...
    public ConsumirDiarioEstadoPorHora(ServicioConsultarDatos servicioConsultarDatos, ServicioGenerarFechasDiarias servicioGenerarFechasDiarias) {
