package co.smart.procesador.diagram.detalleencuestainteligente.consumir;
...
@Component
public class ConsumirDiarioDetalleEncuestaInteligente {
    ...
    public ConsumirDiarioDetalleEncuestaInteligente(ServicioConsultarDatos servicioConsultarDatos, ServicioGenerarFechasDiarias servicioGenerarFechasDiarias) {
    ...
    public Response consumir() throws IOException {
        ...
        Request request = new Request.Builder()
                .url("https://wv"+ip+".wolkvox.com/api/v2/reports_manager.php?api=diagram_4&date_ini="+ini+"&date_end="+fin)
                .method("GET", null)
