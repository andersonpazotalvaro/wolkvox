...
@Component
public class ConsumirDiarioInteraccionesTransferenciaChats {
    ...
    public ConsumirDiarioInteraccionesTransferenciaChats(ServicioConsultarDatos servicioConsultarDatos, ServicioGenerarFechasDiarias servicioGenerarFechasDiarias) {
