package co.smart.procesador.diagram.encuestainteligenteporskill.entidad;

import javax.persistence.*;
import java.time.LocalDate;

@Entity
@Table(name="diagram_encuesta_inteligente_skill")
public class EntidadDiagramEncuestaInteligenteSkill {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long Id_encuesta_inteligente_skill;
    ...
    public EntidadDiagramEncuestaInteligenteSkill() {

    }


    public EntidadDiagramEncuestaInteligenteSkill(String agent_id, String agent_name, int surveys, String q01, String q02, String q03, String q04, String q05, String q06, String q07, String q08, String q09, String q10, float average, LocalDate FECHA, LocalDate fecha_inicio_carga, LocalDate fecha_fin_carga) {
    ...
    public Long getId_encuesta_inteligente_skill() {
        return Id_encuesta_inteligente_skill;
    }

    public void setId_encuesta_inteligente_skill(Long id_encuesta_inteligente_skill) {
        Id_encuesta_inteligente_skill = id_encuesta_inteligente_skill;
    }
    ...
    public void setId_encuesta_inteligente_agente(Long id_encuesta_inteligente_agente) {
        Id_encuesta_inteligente_skill = id_encuesta_inteligente_agente;
    }
