package co.smart.procesador.skillsyservicios.llamadasynivelserviciotodoskilldia.entidad;

import javax.persistence.*;
import java.time.LocalDate;

@Entity
@Table(name="llamadas_y_nivel_servicio_todo_skill_dia")
public class EntidadSkillsLlamadasYNivelServicioTodoSkillDia {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long Id_llamadas_y_nivel_servicio_todo_skill_dia;
    ...
    public EntidadSkillsLlamadasYNivelServicioTodoSkillDia() {
    ...
    public Long getId_llamadas_y_nivel_servicio_todo_skill_dia() {
        return Id_llamadas_y_nivel_servicio_todo_skill_dia;
    }

    public void setId_llamadas_y_nivel_servicio_todo_skill_dia(Long id_llamadas_y_nivel_servicio_todo_skill_dia) {
        Id_llamadas_y_nivel_servicio_todo_skill_dia = id_llamadas_y_nivel_servicio_todo_skill_dia;
    }
